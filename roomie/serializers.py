from .models import user_details,House, house_gallary, previous_stay, education, work, WhatIAm, WhatIWant
...
class WhatIWantSerializer(serializers.ModelSerializer):
    class Meta:
        model = WhatIWant
        fields = '__all__'
